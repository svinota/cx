...
# 	Copyright (c) Lee Busby, William Magro, Guido van Rossum
# 	Copyright (c) 2007-2008 Peter V. Saveliev
#
...
PyDoc_STRVAR(doc_set_display_hook,
"set_display_hook([function]) -> None\n"
);
...
PyDoc_STRVAR(doc_update,
"update() -> None\n\
Forced update of the screen\n\
");
...
static struct PyMethodDef readline_methods[] =
{
	...
	{"update",update, METH_NOARGS, doc_update},
	...
	{"set_display_hook", set_display_hook,
	 METH_VARARGS, doc_set_display_hook},
...
initxreadline(void)
{
	...
	m = Py_InitModule4("xreadline", readline_methods, doc_module,
